#
#  Be sure to run `pod spec lint AliPayAuth.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "lixiaoning"
  # spec.authors            = { "lixiaoning" => "185896739@qq.com" }
  # spec.social_media_url   = "https://twitter.com/lixiaoning"
